...
$strMenu = array('INICIO','ACERCA','CONVOCATORIA','CARAS','PONENTES','TURISMO' );
$ulMenu = '';
...
<div class="modal fade" id="mostrarmodal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" data-keyboard="false" data-backdrop="static">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
            ...
            diferimiento del XV Foro Nacional y I Foro Internacional de Educación en Salud, que se celebrará del 25 al 29 de noviembre de 2019 en Puebla.</p>
            ...
            <header <?php echo $clasehtml ?> >
                <div class="container">
                    <div class="header-wrapper clearfix">
                        ...
                        <!-- Logo -->
                        <div class="logo">
                    <a href="index.php"   title="Foro Nacional y Foro Internacional Educación en Salud" class="scroll-to">
            
                     <img src="assets/img/preview/logo-inicio.png" alt="Foro Nacional y Foro Internacional  Educación en Salud" style="width: 200px;"  class="scroll-to">
